# Codex agent: engineering plan reviewer

Shared rubric: `core/rubrics/engineering-plan-reviewer.md`

## Role

Use this as the Codex-native role prompt for the shared engineering plan reviewer rubric.
