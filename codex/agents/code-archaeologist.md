# Codex agent: code archaeologist

Shared rubric: `core/rubrics/code-archaeologist.md`

## Role

Use this as the Codex-native role prompt for the shared code archaeologist rubric.
