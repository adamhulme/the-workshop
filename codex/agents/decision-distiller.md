# Codex agent: decision distiller

Shared rubric: `core/rubrics/decision-distiller.md`

## Role

Use this as the Codex-native role prompt for the shared decision distiller rubric.
