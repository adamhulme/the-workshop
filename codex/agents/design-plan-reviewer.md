# Codex agent: design plan reviewer

Shared rubric: `core/rubrics/design-plan-reviewer.md`

## Role

Use this as the Codex-native role prompt for the shared design plan reviewer rubric.
