# Codex agent: performance reviewer

Shared rubric: `core/rubrics/performance-reviewer.md`

## Role

Use this as the Codex-native role prompt for the shared performance reviewer rubric.
